...
L_ADDON_LIST = "|cffe60000AddonList|r"
...
-- Misc Localization
L_MISC_UI_OUTDATED = "Your version of |cffe60000Vermilion|r is out of date. You can download the latest version from |cffffe02ewww.github.com/Vermilion|r"
...
L_POPUP_INSTALLUI = "Thank you for choosing |cffe60000Vermilion|r!|n|nAccept this installation dialog to apply settings."
L_POPUP_RELOADUI = "Installation is complete. Please click the 'Accept' button to reload the UI. Enjoy |cffe60000Vermilion|r.|n|nVisit me at |cff2eb6ffwww.github.com/Vermilion|r. |n|n|cff2eb6ffPayPal.Me|r:|r|nwww.paypal.me/Vermilion|r"
L_POPUP_RESETUI = "Are you sure you want to reset all settings for |cffe60000Vermilion|r?"
...
L_POPUP_SETTINGS_ALL = "|cffff0000WARNING:|r This will apply all the supported addons settings and import them to go with |cffe60000Vermilion|r. This feature will not do anything if you do not have one of the supported add-ons."
...
L_WELCOME_LINE_1 = "Welcome to |cffe60000Vermilion|r v"
L_WELCOME_LINE_2_1 = ""
...
L_SLASHCMD_HELP = {
    ...
    "|cff2eb6ff/cfg|r - |cffffe02eOpens |cff2eb6ffVermilion|r |cffffe02esettings.|r.",
    ...
    "|cff2eb6ff/resetconfig|r - |cffffe02eResets |cff2eb6ffVermilion|r |cffffe02esettings.|r",
    "|cff2eb6ff/resetui|r - |cffffe02eResets |cff2eb6ffVermilion|r settings to default.",
