...
local UploadBFacade = function()
	...
	ButtonFacadeDB = {
		["profileKeys"] = {
			["Vermilion - Lordaeron"] = "Default",
		},
		["profiles"] = {
			["Default"] = {
				["Gloss"] = 0,
				["Backdrop"] = true,
				["SkinID"] = "|cff2eb6ffVermilion|r |cFFFFB200Normal|r",
			},
		},
	}
end
						...
						["actionbars"] = {
							{
								...
								["rows"] = 2,
								["skin"] = {
									["ID"] = "|cff2eb6ffVermilion's|r |cFFFFB200Normal|r",
								},
								["version"] = 3,
								["position"] = {
									["y"] = -214,
...
local UploadClassTimer = function()
	...
	ClassTimerDB = {
		["profileKeys"] = {
			["Vermilion - Lordaeron"] = "Vermilion - Lordaeron",
		},
		["profiles"] = {
			["Vermilion - Lordaeron"] = {
				["Units"] = {
...
local UploadMSBT = function()
	...
	MSBT_SavedMedia = {
		["fonts"] = {
			["Vermilion"] = "Interface\\AddOns\\Vermilion\\Media\\Fonts\\Damage.ttf",
		},
		["sounds"] = {
		},
	}
...
StaticPopupDialogs.SETTINGS_ALL = {
	...
	OnAccept = function()
		...
		if (select(4, GetAddOnInfo("DBM-Core"))) and C.Skins.DBM then V.UploadDBM() end
...
SlashCmdList.SETTINGS = function(msg)
	if msg == "nameplates" then
		if (select(4, GetAddOnInfo("Nameplates"))) then
			...
			V.Print("Nameplates".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "threatplates" then
		if (select(4, GetAddOnInfo("TidyPlates_ThreatPlates"))) then
			...
			V.Print("TidyPlates_ThreatPlates".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "classtimer" then
		if (select(4, GetAddOnInfo("ClassTimer"))) then
			...
			V.Print("ClassTimer".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "bfacade" then
		if (select(4, GetAddOnInfo("ButtonFacade"))) then
			...
			V.Print("ButtonFacade".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "color" then
		if (select(4, GetAddOnInfo("!ClassColors"))) then
			...
			V.Print("!ClassColors".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "mapster" then
		if (select(4, GetAddOnInfo("Mapster"))) then
			...
			V.Print("Mapster".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "chatfilter" then
		if (select(4, GetAddOnInfo("ChatConsolidate"))) then
			...
			V.Print("ChatConsolidate".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "bartender4" then
		if (select(4, GetAddOnInfo("Bartender4"))) then
			...
			V.Print("Bartender4".."|cffffe02e"..L_INFO_NOT_INSTALLED.."|r")
		end
	elseif msg == "gird" then
		if (select(4, GetAddOnInfo("Grid"))) then
			...
			V.Print("Grid".."|cffffe02e"..L_INFO_NOT_INSTALLED.."|r")
		end
	elseif msg == "xloot" then
		if (select(4, GetAddOnInfo("XLoot"))) then
			...
			V.Print("XLoot".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "skada" then
		if (select(4, GetAddOnInfo("Skada"))) then
			...
			V.Print("Skada".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "msbt" then
		if (select(4, GetAddOnInfo("MikScrollingBattleText"))) then
			...
			V.Print("MikScrollingBattleText".."|cffffe02e"..L_INFO_NOT_INSTALLED)
		end
	elseif msg == "all" then
