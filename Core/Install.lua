...
local function InstallUI()
	...
	if V.Name == "Vermilion" or V.Name == "Rollndots" or V.Name == "Broflex" then
...
Install:SetScript("OnEvent", function(self, event, addon)
	...
	-- Install default if we never ran Vermilion on this character
	...
	if C.General.WelcomeMessage == true then
		print("|cffffe02e"..L_WELCOME_LINE_1..V.Version.." "..V.Client..", "..format("|cff%02x%02x%02x%s|r", V.Color.r * 255, V.Color.g * 255, V.Color.b * 255, V.Name)..".|r")
...
if C.General.TranslateMessage == true then
	if GetLocale() == "esES" or GetLocale() == "koKR" or GetLocale() == "esMX" or GetLocale() == "deDE" or GetLocale() == "frFR" or GetLocale() == "koKR" or GetLocale() == "zhCN" or GetLocale() == "zhTW" then
		print("|cffffe02ePlease help us translate the text settings for |cff2eb6ffVermilion|r. |cffffe02eYou can post a commit to|r |cff2eb6ffgithub.com/Vermilion/Vermilion|r")
	end
end