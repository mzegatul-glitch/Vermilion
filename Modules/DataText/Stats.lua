...
local function Update(self, t)
	...
	if int < 0 then
		...
		Text:SetText(floor(GetFramerate())..V.RGBToHex(V.Color.r, V.Color.g, V.Color.b).." fps|r & "..select(3, GetNetStats())..V.RGBToHex(V.Color.r, V.Color.g, V.Color.b).." ms|r")
		int = 10
	end
end
-- Setup Tooltip
...
Stat:SetScript("OnMouseDown", function(self, btn)
	if (btn == "LeftButton") then
		...
		UpdateAddOnMemoryUsage()
		local After = gcinfo()
		V.Print(L_DATATEXT_MEMORY_CLEANED..formatMem(Before-After))
	end
end)
