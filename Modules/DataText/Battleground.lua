...
local classcolor = ("|cff%.2x%.2x%.2x"):format(V.Color.r * 255, V.Color.g * 255, V.Color.b * 255)
	...
	if int < 0 then
		...
		for i = 1, numScores do
			...
			if healingDone > damageDone then
				dmgtxt = (classcolor..SHOW_COMBAT_HEALING.." :|r "..V.ShortValue(healingDone))
			else
				dmgtxt = (classcolor..DAMAGE.." :|r "..V.ShortValue(damageDone))
			end
			if name and name == V.Name then
