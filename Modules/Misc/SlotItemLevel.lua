local addonTable = select(2, ...)  -- ← ЭНД АВНА!

-- ЗАСАВ: ADDON_LOADED дотор дуудагдана
local frame = CreateFrame("Frame")
frame:RegisterEvent("ADDON_LOADED")
frame:SetScript("OnEvent", function(self, event, addon)
    if addon ~= "Vermilion" then return end
    
    -- Profile merge дууссаны дараа C зөв утгуудтай байна!
    local V, C, L = addonTable:unpack()  -- ← addonTable-с авна!
