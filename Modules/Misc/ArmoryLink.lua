...
hooksecurefunc("UnitPopup_OnClick", function(self)
	...
	if name and self.value == "ARMORYLINK" then
		...
		if V.Realm == "Icecrown" or V.Realm == "Lordaeron" then
			...
			V.Print("|cffffe02eThis realm is not currently supported|r")
...
for _, menu in pairs(UnitPopupMenus) do
	for index = #menu, 1, -1 do
		if menu[index] == "SET_FOCUS" or menu[index] == "CLEAR_FOCUS" or menu[index] == "MOVE_PLAYER_FRAME" or menu[index] == "MOVE_TARGET_FRAME" or menu[index] == "LARGE_FOCUS" or menu[index] == "MOVE_FOCUS_FRAME" or (menu[index] == "PET_DISMISS" and V.Class == "HUNTER") then
			remove(menu, index)
		end
	end
end