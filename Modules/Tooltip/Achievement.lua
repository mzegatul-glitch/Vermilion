	...
	if completed then
		...
		if earnedBy then
			...
			if not wasEarnedByMe then
				tooltip:AddLine(format(ACHIEVEMENT_NOT_COMPLETED_BY, V.Name))
			elseif V.Name ~= earnedBy then
				tooltip:AddLine(format(ACHIEVEMENT_COMPLETED_BY, V.Name))
			end
		end
