...
do
	...
	function _NS.CreateSlot(id)
		...
		count:SetShadowOffset((V.Mult or 1), -(V.Mult or 1))
		count:SetText(1)
		frame.count = count
		...
		name:SetShadowOffset((V.Mult or 1), -(V.Mult or 1))
