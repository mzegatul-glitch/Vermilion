...
if not IsAddOnLoaded("CLCRet") or C.Skins.CLCRet ~= true or V.Class ~= "PALADIN" then return end
...
function clcret:CreateButton(name, size, point, parent, pointParent, offsetx, offsety, bfGroup, isChecked)
	...
	button.texture.SetTexCoord = V.Noop
