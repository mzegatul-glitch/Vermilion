...
local function SkinFrame(frame)
	...
	if frame == Recount.MainWindow then
		...
		frame.Title:SetShadowOffset((V.Mult or 1), -(V.Mult or 1))
...
local function SkinButton(frame, text)
	...
	frame:HookScript("OnEnter", function(self) self.text:SetTextColor(V.Color.r, V.Color.g, V.Color.b) end)
...
Recount.UpdateBarTextures = function(self)
	for k, v in pairs(Recount.MainWindow.Rows) do
		...
		v.LeftText:SetShadowOffset((V.Mult or 1), -(V.Mult or 1))

		v.RightText:SetFont(C.Media.Font, C.Media.Font_Size)
		v.RightText:SetShadowOffset((V.Mult or 1), -(V.Mult or 1))
	end
end
...
if not RecountDB["profiles"][V.Name.." - "..GetRealmName()] then RecountDB["profiles"][V.Name.." - "..V.Realm] = {} end
if not RecountDB["profiles"][V.Name.." - "..GetRealmName()]["MainWindow"] then RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"] = {} end

RecountDB["profiles"][V.Name.." - "..V.Realm]["Locked"] = true
RecountDB["profiles"][V.Name.." - "..V.Realm]["Scaling"] = 1
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["RowHeight"] = 15
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["RowSpacing"] = 1
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["ShowScrollbar"] = false
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["HideTotalBar"] = true
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["Position"]["x"] = 469.00
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["Position"]["y"] = -460.00
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["Position"]["w"] = 230.00
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["Position"]["h"] = 120.00
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindow"]["BarText"]["NumFormat"] = 3
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindowWidth"] = 230.00
RecountDB["profiles"][V.Name.." - "..V.Realm]["MainWindowHeight"] = 120.00
RecountDB["profiles"][V.Name.." - "..V.Realm]["ClampToScreen"] = true
RecountDB["profiles"][V.Name.." - "..V.Realm]["Font"] = "Vermilion Normal"